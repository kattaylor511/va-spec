...
The effect of a variant on a downstream transcript and protein.

**Information Model**

Some MolecularConsequence attributes are inherited from :ref:`StudyResult`.
...
.. list-table::
   ...
   *  - type
      ...
      - string
      - 1..1
      - MUST be "MolecularConsequence".
   *  - focusVariant
      -
      - :ref:`Allele` | :ref:`iriReference`
      - 1..1
      - The variant which this annotation applies to.
   *  - transcriptMolecule
      -
   ...
   *  - transcriptVariant
      ...
      - :ref:`Allele` | :ref:`iriReference`
      - 0..1
      - The sequence change caused by the variant on the downstream transcript.
   *  - proteinMolecule
      -
      - :ref:`SequenceReference` | :ref:`iriReference`
      - 0..1
      - The protein affected by the variant
   *  - proteinVariant
      -
                        .. raw:: html
      ...
      - :ref:`Allele` | :ref:`iriReference`
      - 0..1
      - The sequence change caused by the variant on the downstream protein
   *  - gene
      -
      - :ref:`MappableConcept` | :ref:`iriReference`
      - 0..1
      - The gene affected by the variant. The objectMolecule should be a transcript or protein for this gene.
   *  - geneDistance
      -
      - number
      - 0..1
      - The distance to the affected gene (for variants upstream and downstream of a gene).
   *  - consequenceTerms
      -
                        .. raw:: html
